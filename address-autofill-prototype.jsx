...
const s = {
  ...
  confirm: { position: "absolute", width: "100%", zIndex: 10, background: "#fafafa", border: `1px solid #e0e0e0`, borderRadius: 3, padding: "10px 12px", marginTop: 6, fontSize: 12, color: "#555", lineHeight: 1.5, boxSizing: "border-box" },
