...
const s = {
  ...
  input: (variant) => ({
    ...
    padding: "0 10px",
    fontSize: 13,
    color: variant === "autofill" ? colors.tealDark : variant === "placeholder" ? colors.grayLight : variant === "dim" ? colors.grayLight : colors.inputText,
  ...
  select: (variant) => ({
    ...
    fontSize: 13,
    color: variant === "autofill" ? colors.tealDark : variant === "placeholder" ? colors.grayLight : colors.inputText,
